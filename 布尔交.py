...
from OCC.Core.BRepPrimAPI import (BRepPrimAPI_MakeSphere, BRepPrimAPI_MakeCylinder,
                                  BRepPrimAPI_MakeTorus, BRepPrimAPI_MakeRevol, BRepPrimAPI_MakeBox)
...
def boolean_fuse(base):
    ...
    new_BOPAlgo_PaveFiller=BOPAlgo_PaveFiller()
...
def generate_demo():
    new_BOPAlgo_PaveFiller = BOPAlgo_PaveFiller()
    my_box1 = BRepPrimAPI_MakeBox (10,10,10).Shape()
    my_box2 = BRepPrimAPI_MakeBox(10, 10, 15).Shape()

    #new_BOPAlgo_PaveFiller.AddArgument(my_box2,my_box1)

    fuse = BRepAlgoAPI_Fuse(my_box1,my_box2)
    fuse.SimplifyResult()#简化模型
